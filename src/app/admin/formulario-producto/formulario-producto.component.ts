...
export class FormularioProductoComponent implements PuedeSalir, OnInit {
  ...
  constructor() {
    this.formulario.controls.descripcion.valueChanges
      ...
      .subscribe(descripcion => {
        this.caracteresRestantes.set(500 - descripcion.length);
      });
  }
  ...
  agregarImagen(): void {
    this.imagenes.push(this.crearImagen());
  }
  ...
  guardar(): void {
    ...
    const solicitud$ = this.productoId === null
